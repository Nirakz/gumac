			...
			<Container>
				<Row>
					<Col>
						<Row md={1}>
							<Col>
								<Card.Img style={{ width: "158px", height: "101px" }} src="../image/logo-footer.png" />
							</Col>
							<Col className="mt-4" style={{ width: "295px" }}>
								Tự hào là thương hiệu Việt, không chỉ mang đến những sản phẩm đẹp mà còn trao gửi những
								Giá trị thật - Hạnh phúc đích thực đến tận tay khách hàng.
							</Col>
							<Col className="my-5">
					...
					<Col>
						...
						<Row className="mt-4" md={4}>
							<Col>
								<Card.Img src="../image/money.svg" />
							</Col>
							<Col>
								<Card.Img src="../image/banking.svg" />
							</Col>
							<Col>
								<Card.Img src="../image/momo.svg" />
							</Col>
							<Col>
								<Card.Img src="../image/vnpay.svg" />
							</Col>
						</Row>
					</Col>
				</Row>
